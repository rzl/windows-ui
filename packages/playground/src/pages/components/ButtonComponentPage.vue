<template>
  <div class="demo-page">
    ...
    <demo-section :title="title" description="基础操作按钮，支持多种类型和尺寸" id="button" doc="button">

            <demo-block title="按钮类型" code="&lt;w-space wrap&gt;
      ...
      &lt;/w-space&gt;">
            ...
            <demo-block title="朴素按钮" code="&lt;w-space&gt;
      ...
      &lt;/w-space&gt;">
            ...
            <demo-block title="圆角按钮" code="&lt;w-space&gt;
      ...
      &lt;/w-space&gt;">
            ...
            <demo-block title="按钮尺寸" code="&lt;w-space&gt;
      ...
      &lt;/w-space&gt;">
            ...
            <demo-block title="禁用状态" code="&lt;w-space&gt;
      ...
      &lt;/w-space&gt;">
            ...
            <demo-block title="图标按钮" code="&lt;w-space&gt;
