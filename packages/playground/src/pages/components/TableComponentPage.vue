<template>
  <div class="demo-page">
    ...
    <demo-section :title="title" :description="t('数据表格')" id="table" doc="table">
      ...
      <demo-block :title="t('基础表格')" :code="codeBasic"><w-table :data="tableData" :columns="tableColumns" /></demo-block>

      <demo-block :title="t('自定义列模板')" :code="codeSlot"><w-table :data="tableData" :columns="tableColumns">
        <template #status="{ row }">
      ...
      <demo-block :title="t('空数据表格')" :code="codeEmpty"><w-table :data="[]" :columns="tableColumns" /></demo-block>

      <demo-block :title="t('带边框 + 斑马纹 + 列宽')" :code="codeBorderStripe">
        <w-table :data="stripeData" :columns="stripeColumns" border stripe />
      </demo-block>

      <demo-block :title="t('多选行')" :code="codeSelection">
      ...
      <demo-block :title="t('单选高亮')" :code="codeHighlight">
      ...
      <demo-block :title="t('排序')" :code="codeSort">
      ...
      <demo-block :title="t('筛选')" :code="codeFilter">
      ...
      <demo-block :title="t('尺寸规格')" :code="codeSize">
      ...
      <demo-block :title="t('行样式自定义')" :code="codeRowClass">
        <w-table :data="rowClassData" :columns="tableColumns" :row-class-name="rowClassName" />
      </demo-block>

      <demo-block :title="t('分页联动')" :code="codePagination">
      ...
      <demo-block :title="t('列宽拖拽')" :code="codeResize">
      ...
      <demo-block :title="t('固定表头')" :code="codeFixedHeader">
        <w-table :data="fixedHeaderData" :columns="fixedHeaderColumns" :max-height="300" border />
      </demo-block>

      <demo-block :title="t('固定列')" :code="codeFixedColumn">
        <div style="max-width: 480px; border: 1px solid #919b9c;">
      ...
      <demo-block :title="t('树形表格')" :code="codeTree">
        <w-table :data="treeData" :columns="treeColumns" row-key="id" default-expand-all />
      </demo-block>

      <demo-block :title="t('树形表格 + 多选')" :code="codeTreeSelection">
      ...
      <demo-block :title="t('虚拟滚动')" :code="codeVirtualScroll">
      ...
      <demo-block :title="t('横向虚拟滚动')" :code="codeVirtualX">
      ...
      <demo-block :title="t('虚拟化表格')" :code="codeVirtual"><w-virtualized-table :data="virtualData" :columns="virtualColumns" :height="300" /></demo-block>
