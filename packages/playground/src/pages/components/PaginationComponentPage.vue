<template>
  <div class="demo-page">
    ...
    <demo-section :title="title" :description="t('分页导航')" id="pagination" doc="pagination">

      <demo-block :title="t('基础用法')" :code="PaginationCode1"><w-pagination v-model:current-page="form.page" :total="100" /></demo-block>
...
const title = t('Pagination 分页')

const PaginationCode1 = `<w-pagination v-model:current-page="form.page" :total="100" />`
</script>
