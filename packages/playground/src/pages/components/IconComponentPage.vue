...
const iconGroups = [
  ...
  { title: t('页面设计器'), names: ['box', 'card', 'layout', 'tabs', 'font', 'divider', 'stats', 'alert', 'progress', 'avatar', 'badge', 'steps', 'timeline', 'table', 'input', 'select', 'radio', 'checkbox', 'switch', 'button', 'component', 'form', 'number', 'slider', 'rate', 'color', 'cascader', 'transfer', 'tree', 'dialog', 'drawer', 'popover', 'tooltip', 'pagination', 'breadcrumb', 'collapse', 'space', 'carousel', 'rich-text', 'search-form', 'query-builder', 'dynamic-form', 'segmented', 'tour', 'affix', 'anchor', 'autocomplete', 'backtop', 'border', 'date-picker-panel', 'descriptions', 'empty', 'infinite-scroll', 'message-box', 'notification', 'page-designer', 'scrollbar', 'skeleton', 'splitter'] }
]
