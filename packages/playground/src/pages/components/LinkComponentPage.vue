<template>
  <div class="demo-page">
    ...
    <demo-section :title="title" description="文字链接" id="link" doc="link">

            <demo-block title="链接类型" code="&lt;w-space&gt;
        &lt;w-link&gt;默认链接&lt;/w-link&gt;
      ...
      &lt;/w-space&gt;">
            ...
            <demo-block title="无下划线" code="&lt;w-link :underline=&quot;false&quot;&gt;无下划线&lt;/w-link&gt;">
              <w-link :underline="false">无下划线</w-link>
            </demo-block>
            <demo-block title="禁用状态" code="&lt;w-link disabled&gt;禁用链接&lt;/w-link&gt;">
              <w-link disabled>禁用链接</w-link>
            </demo-block>
