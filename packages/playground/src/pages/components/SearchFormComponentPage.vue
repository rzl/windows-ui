<template>
  <div class="demo-page">
    ...
    <demo-section :title="title" :description="t('带查询和重置的搜索表单')" id="search-form" doc="search-form">
      ...
      <demo-block :title="t('基础用法')" code="&lt;w-search-form :model=&quot;searchModel&quot; @search=&quot;onSearch&quot; @reset=&quot;onReset&quot;&gt;
...
&lt;/w-search-form&gt;">
      ...
      <demo-block :title="t('可折叠')" code="&lt;w-search-form :model=&quot;searchModel2&quot; collapsible @search=&quot;onSearch&quot; @reset=&quot;onReset&quot;&gt;
