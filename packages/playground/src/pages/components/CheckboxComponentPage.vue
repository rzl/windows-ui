<template>
  <div class="demo-page">
    ...
    <demo-section :title="title" :description="t('多项选择')" id="checkbox" doc="checkbox">
            ...
            <demo-block :title="t('基础用法')" :code="CheckboxCode1">
            ...
            <demo-block :title="t('禁用')" :code="CheckboxCode2"><w-checkbox v-model="form.checkbox" label="D" disabled>禁用选项</w-checkbox></demo-block>
            <demo-block :title="t('半选状态')" :code="CheckboxCode3"><w-checkbox :indeterminate="true">半选</w-checkbox></demo-block>
