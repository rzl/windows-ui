<template>
  <div class="demo-page">
    ...
    <demo-section :title="title" :description="t('多项选择')" id="checkbox" doc="checkbox">

            <demo-block :title="t('基础用法')" code="&lt;w-checkbox v-model=&quot;form.checkbox&quot; label=&quot;A&quot;&gt;选项A&lt;/w-checkbox&gt;
      ...
      &lt;w-checkbox v-model=&quot;form.checkbox&quot; label=&quot;C&quot;&gt;选项C&lt;/w-checkbox&gt;">
            ...
            <demo-block :title="t('禁用')" code="&lt;w-checkbox v-model=&quot;form.checkbox&quot; label=&quot;D&quot; disabled&gt;禁用选项&lt;/w-checkbox&gt;"><w-checkbox v-model="form.checkbox" label="D" disabled>禁用选项</w-checkbox></demo-block>
            <demo-block :title="t('半选状态')" code="&lt;w-checkbox :indeterminate=&quot;true&quot;&gt;半选&lt;/w-checkbox&gt;"><w-checkbox :indeterminate="true">半选</w-checkbox></demo-block>
