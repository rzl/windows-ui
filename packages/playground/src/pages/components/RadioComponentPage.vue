<template>
  <div class="demo-page">
    ...
    <demo-section :title="title" :description="t('单项选择')" id="radio" doc="radio">

            <demo-block :title="t('基础用法')" :code="RadioCode1">
            ...
            <demo-block :title="t('禁用')" :code="RadioCode2"><w-radio v-model="form.radio" label="D" disabled>禁用选项</w-radio></demo-block>
