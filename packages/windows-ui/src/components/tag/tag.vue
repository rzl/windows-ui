...
const props = defineProps({ type: { type: String, default: 'default' }, size: { type: String, default: 'default' }, closable: Boolean, hit: Boolean, color: String, bgColor: String })
...
<style scoped>
.w-tag { display: inline-flex; align-items: center; gap: 2px; padding: 2px 8px; border-radius: var(--w-border-radius-base); font-size: var(--w-font-size-base); border: 1px solid #919b9c; background: #f0f0f0; color: var(--w-text-color-primary); }
...
.w-tag--small { padding: 1px 6px; font-size: var(--w-font-size-small); }
.w-tag--large { padding: 4px 10px; font-size: var(--w-font-size-medium); }
