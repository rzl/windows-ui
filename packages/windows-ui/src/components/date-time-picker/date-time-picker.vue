...
const props = defineProps({ modelValue: String, placeholder: { type: String, default: '选择日期时间' }, clearable: { type: Boolean, default: true }, size: { type: String, default: undefined } })
