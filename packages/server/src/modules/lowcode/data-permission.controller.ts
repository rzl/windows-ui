...
export async function getRuleById(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const result = await service.getDataPermissionRuleById(req, req.params.id)
    res.json(success(result))
  } catch (err) {
    next(err)
  }
...
export async function updateRule(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const result = await service.updateDataPermissionRule(req, req.params.id, req.body)
    res.json(success(result))
  } catch (err) {
    next(err)
  }
...
export async function deleteRule(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    await service.deleteDataPermissionRule(req, req.params.id)
